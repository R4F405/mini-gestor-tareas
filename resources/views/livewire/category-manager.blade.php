<div class="p-4 bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
    ...
    <form wire:submit.prevent="addCategory" class="mb-4">
        <h3 class="text-lg font-semibold mb-2 dark:text-gray-200">Añadir una categoría</h3>
        <div class="flex space-x-2">
            <input type="text" wire:model="newCategoryName" id="newCategoryName"
                   class="block w-full rounded-md border-gray-300 dark:text-gray-200 dark:bg-gray-700 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
    ...
    {{-- Lista de categorías --}}
    <div>
        <h3 class="text-lg font-semibold mb-2 dark:text-gray-200">Lista de categorías</h3>
        <div class="flex flex-wrap gap-2">
            ...
            @empty
                <p class="text-gray-500 text-sm dark:text-gray-200">No hay categorías.</p>
            @endforelse
        </div>
    </div>
</div>